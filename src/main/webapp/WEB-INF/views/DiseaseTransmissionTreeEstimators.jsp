...
if (!$('#min-occurs-zero-5-instance-1').is(':checked')) return '';
  ...
  //extract xml from element <DiseaseTransmissionTreeEstimators>
  function getXml1instance() {

    var xml = '\n' + spaces(0) + '<DiseaseTransmissionTreeEstimators xmlns="http://mdc.isg.pitt.edu/v1_0/">';
    //now add sequence children for each instanceNo
    ...
    xml += '\n' + spaces(0) + '</DiseaseTransmissionTreeEstimators>';
    return xml;
  }
...
<div class="form">
  ...
  <div id="item-enclosing-1-instance-1" class="sequence">
    <div id="repeating-enclosing-1-instance-1" class="repeating-enclosing">
      <div class="sequence-label">Disease Transmission Tree Estimators</div>
