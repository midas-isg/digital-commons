        ...
        <div class="col-xs-12">
            <form:form id="entry-form" action="${pageContext.request.contextPath}/testAddDatasetOrg" modelAttribute="datasetWithOrganization">
                <div class="form-group edit-form-group">
                    ...
                    <myTags:editRequiredNonZeroLengthString label="Title" placeholder="Title" path="title" string="${datasetWithOrganization.title}"></myTags:editRequiredNonZeroLengthString>
                    <myTags:editNonRequiredNonZeroLengthString path="description" string="${datasetWithOrganization.description}" specifier="description" placeholder="Description" label="Description"></myTags:editNonRequiredNonZeroLengthString>
                    ...
                    <myTags:editDistributions distributions="${datasetWithOrganization.distributions}" specifier="distributions" path="distributions"></myTags:editDistributions>
                    <myTags:editExtraProperties categoryValuePairs="${datasetWithOrganization.extraProperties}" specifier="extraProperties" path="extraProperties"></myTags:editExtraProperties>
                </div>
