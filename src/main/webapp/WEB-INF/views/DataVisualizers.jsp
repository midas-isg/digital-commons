...
if (!$('#min-occurs-zero-5-instance-1').is(':checked')) return '';
  ...
  //extract xml from element <visualizationType>
  ...
  if (idVisible('repeating-enclosing-26-instance-1_1')) {
    ...
    if (v.length>0)
      xml += '\n' + spaces(2) + '<visualizationType>' + v + '</visualizationType>';
  }
  ...
  //extract xml from element <DataVisualizers>
  function getXml1instance() {

    var xml = '\n' + spaces(0) + '<DataVisualizers xmlns="http://mdc.isg.pitt.edu/v1_0/">';
    //now add sequence children for each instanceNo
...
<div class="form col-xs-12 margin-bottom-30">
  ...
  <div id="item-enclosing-1-instance-1" class="sequence">
    <div id="repeating-enclosing-1-instance-1" class="repeating-enclosing">
      <div class="sequence-label">Data Visualizer</div>
      <div id="sequence-1-instance-1" class="sequence-content">
        ...
        <div id="item-enclosing-26-instance-1_1" class="item-enclosing">
          <div id="repeat-button-26-instance-1" class="btn btn-sm btn-default">Add Visualization Type</div>
          <div class="clr">
          </div>
          <div id="repeating-enclosing-26-instance-1_1" class="repeating-enclosing invisible">
            ...
            <label class="item-label" for="item-input-26-instance-1_1">Visualization Type</label>
            <div class="item-input">
              <input number="26" name="item-input-26-instance-1_1" path="['visualizationType'][0]" id="item-26-instance-1_1" class=" item-input-text" type="text">
              </input>
          ...
          <div id="repeating-enclosing-26-instance-1_2" class="repeating-enclosing invisible">
            ...
            <div class="item-number">26</div>
            <label class="item-label" for="item-input-26-instance-1_2">Visualization Type</label>
            <div class="item-input">
              <input number="26" name="item-input-26-instance-1_2" path="['visualizationType'][1]" id="item-26-instance-1_2" class=" item-input-text" type="text">
              </input>
          ...
          <div id="repeating-enclosing-26-instance-1_3" class="repeating-enclosing invisible">
            ...
            <div class="item-number">26</div>
            <label class="item-label" for="item-input-26-instance-1_3">Visualization Type</label>
            <div class="item-input">
              <input number="26" name="item-input-26-instance-1_3" path="['visualizationType'][2]" id="item-26-instance-1_3" class=" item-input-text" type="text">
              </input>
          ...
          <div id="repeating-enclosing-26-instance-1_4" class="repeating-enclosing invisible">
            ...
            <div class="item-number">26</div>
            <label class="item-label" for="item-input-26-instance-1_4">Visualization Type</label>
            <div class="item-input">
              <input number="26" name="item-input-26-instance-1_4" path="['visualizationType'][3]" id="item-26-instance-1_4" class=" item-input-text" type="text">
              </input>
          ...
          <div id="repeating-enclosing-26-instance-1_5" class="repeating-enclosing invisible">
            ...
            <div class="item-number">26</div>
            <label class="item-label" for="item-input-26-instance-1_5">Visualization Type</label>
            <div class="item-input">
              <input number="26" name="item-input-26-instance-1_5" path="['visualizationType'][4]" id="item-26-instance-1_5" class=" item-input-text" type="text">
              </input>
          ...
          <div id="repeating-enclosing-26-instance-1_6" class="repeating-enclosing invisible">
            ...
            <div class="item-number">26</div>
            <label class="item-label" for="item-input-26-instance-1_6">Visualization Type</label>
            <div class="item-input">
              <input number="26" name="item-input-26-instance-1_6" path="['visualizationType'][5]" id="item-26-instance-1_6" class=" item-input-text" type="text">
              </input>
          ...
          <div id="repeating-enclosing-26-instance-1_7" class="repeating-enclosing invisible">
            ...
            <div class="item-number">26</div>
            <label class="item-label" for="item-input-26-instance-1_7">Visualization Type</label>
            <div class="item-input">
              <input number="26" name="item-input-26-instance-1_7" path="['visualizationType'][6]" id="item-26-instance-1_7" class=" item-input-text" type="text">
              </input>
          ...
          <div id="repeating-enclosing-26-instance-1_8" class="repeating-enclosing invisible">
            ...
            <div class="item-number">26</div>
            <label class="item-label" for="item-input-26-instance-1_8">Visualization Type</label>
            <div class="item-input">
              <input number="26" name="item-input-26-instance-1_8" path="['visualizationType'][7]" id="item-26-instance-1_8" class=" item-input-text" type="text">
              </input>
          ...
          <div id="repeating-enclosing-26-instance-1_9" class="repeating-enclosing invisible">
            ...
            <div class="item-number">26</div>
            <label class="item-label" for="item-input-26-instance-1_9">Visualization Type</label>
            <div class="item-input">
              <input number="26" name="item-input-26-instance-1_9" path="['visualizationType'][8]" id="item-26-instance-1_9" class=" item-input-text" type="text">
              </input>
          ...
          <div id="repeating-enclosing-26-instance-1_10" class="repeating-enclosing invisible">
            ...
            <div class="item-number">26</div>
            <label class="item-label" for="item-input-26-instance-1_10">Visualization Type</label>
            <div class="item-input">
              <input number="26" name="item-input-26-instance-1_10" path="['visualizationType'][9]" id="item-26-instance-1_10" class=" item-input-text" type="text">
              </input>
