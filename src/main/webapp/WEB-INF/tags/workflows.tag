    ...
    <div>
        ...
        <div class="font-size-16 standard-font">
            ...
            <div class="col-md-12 col-lg-12 no-padding">
                ...
                <img id="workflow-none-img" src="${pageContext.request.contextPath}/resources/img/workflow_none_selected.jpg" style="width:100%">
                <img id="workflow-spew-img" src="${pageContext.request.contextPath}/resources/img/workflow_spew_selected.jpg" style="width:100%; display:none;">
                <img id="workflow-synthia-img" src="${pageContext.request.contextPath}/resources/img/workflow_synthia_selected.jpg" style="width:100%; display:none;">
