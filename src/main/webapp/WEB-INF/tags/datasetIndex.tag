    ...
    <ul class="list-unstyled components">
        <c:choose>
            <c:when test="${active == 'basic'}">
                <li class="active"><a href="#basicSubmenu" data-toggle="collapse" aria-expanded="false"
                                      class="dropdown-toggle">Basic Info</a></li>
            </c:when>
            <c:otherwise>
                <li><a href="#basicSubmenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">Basic
                    Info</a></li>
            </c:otherwise>
        </c:choose>
        ...
        <c:choose>
            <c:when test="${active == 'types'}">
                <li class="active"><a href="#typesSubmenu" data-toggle="collapse" aria-expanded="false"
                                      class="dropdown-toggle">Types</a></li>
            </c:when>
            <c:otherwise>
                <li><a href="#typesSubmenu" data-toggle="collapse" aria-expanded="false"
                       class="dropdown-toggle">Types</a></li>
            </c:otherwise>
        </c:choose>
        ...
        <c:choose>
            <c:when test="${active == 'citation'}">
                <li class="active"><a href="#citationSubmenu" data-toggle="collapse" aria-expanded="false"
                                      class="dropdown-toggle">Citation</a></li>
            </c:when>
            <c:otherwise>
                <li><a href="#citationSubmenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">Citation</a>
                </li>
            </c:otherwise>
        </c:choose>
        ...
        <c:choose>
            <c:when test="${active == 'extra'}">
                <li class="active"><a href="#extraSubmenu" data-toggle="collapse" aria-expanded="false"
                                      class="dropdown-toggle">Extra Properties</a></li>
            </c:when>
            <c:otherwise>
                <li><a href="#extraSubmenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">Extra
                    Properties</a></li>
            </c:otherwise>
        </c:choose>
