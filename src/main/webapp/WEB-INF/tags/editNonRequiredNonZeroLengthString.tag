...
<div id="${id}" class="form-group <c:if test="${not isUnboundedList}">edit-form-group</c:if> <c:if test="${not empty id}">hide</c:if>">
    ...
    <div id="${specifier}-input-block"
         class="input-group control-group full-width <c:if test="${empty string and not isUnboundedList}">hide</c:if>">
        <c:choose>
