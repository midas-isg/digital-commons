...
<link rel="icon" type="image/png" href="${pageContext.request.contextPath}/resources/img/favicon-32x32.png" sizes="32x32">
<link rel="icon" type="image/png" href="${pageContext.request.contextPath}/resources/img/favicon-16x16.png" sizes="16x16">
