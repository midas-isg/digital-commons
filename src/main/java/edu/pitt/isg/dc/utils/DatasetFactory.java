...
public class DatasetFactory {
    ...
    private boolean wrapLists = true;

    public DatasetFactory(boolean wrapLists) {
        this.wrapLists = wrapLists;
    }

    public Dataset createDatasetForWebFlow(Dataset dataset) {
...
//        Dataset dataset = new Dataset();
        ...
        if (dataset.getDates().isEmpty()) {
            ...
            dataset.setDates(wrapListWithAutoPopulatingList(createDateList(dataset.getDates()), AutoPopulatedDateWrapper.class));
        ...
        if (dataset.getSpatialCoverage().isEmpty()) {
            ...
            dataset.setSpatialCoverage(wrapListWithAutoPopulatingList(createPlaceList(dataset.getSpatialCoverage()), AutoPopulatedPlaceWrapper.class));
...
//        }
        if (dataset.getDistributions().isEmpty()) {
            ...
            dataset.setDistributions(wrapListWithAutoPopulatingList(createDistributionList(dataset.getDistributions()), AutoPopulatedDistributionWrapper.class));
        if (dataset.getPrimaryPublications().isEmpty()) {
            ...
            dataset.setPrimaryPublications(wrapListWithAutoPopulatingList(createPublicationList(dataset.getPrimaryPublications()), AutoPopulatedPublicationWrapper.class));
        if (dataset.getCitations().isEmpty()) {
            ...
            dataset.setCitations(wrapListWithAutoPopulatingList(createPublicationList(dataset.getCitations()), AutoPopulatedPublicationWrapper.class));
        ...
        if (dataset.getCreators().isEmpty()) {
            ...
            dataset.setCreators(wrapListWithAutoPopulatingList(createPersonComprisedEntityList(dataset.getCreators()), AutoPopulatedPersonComprisedEntityWrapper.class));
        if (dataset.getLicenses().isEmpty()) {
            ...
            dataset.setLicenses(wrapListWithAutoPopulatingList(createLicenseList(dataset.getLicenses()), AutoPopulatedLicenseWrapper.class));
        ...
        if (dataset.getAcknowledges().isEmpty()) {
            ...
            dataset.setAcknowledges(wrapListWithAutoPopulatingList(createGrantList(dataset.getAcknowledges()), AutoPopulatedGrantWrapper.class));
        if (dataset.getExtraProperties().isEmpty()) {
            ...
            dataset.setExtraProperties(wrapListWithAutoPopulatingList(createCategoryValuePairList(dataset.getExtraProperties()), AutoPopulatedCategoryValuePairWrapper.class));
    ...
    public <T> List<T> wrapListWithAutoPopulatingList(List<T> list, Class<?> pojoClazz) {
        if (wrapLists)
            return new AutoPopulatingList(list, pojoClazz);
        else
            return list;
    }

    public int maxIterations(Integer listSize) {
        if (listSize > MAX_ITERATIONS) {
            return listSize;
        } else return MAX_ITERATIONS;
    }

    public List<Distribution> createDistributionList(List<Distribution> distributionList) {
    ...
    public Distribution createDistribution(Distribution distribution) {
        ...
        if (distribution.getAlternateIdentifiers().isEmpty()) {
            ...
            distribution.setAlternateIdentifiers(wrapListWithAutoPopulatingList(createIdentifierList(distribution.getAlternateIdentifiers()), Identifier.class));
        ...
        if (distribution.getDates().isEmpty()) {
            ...
            distribution.setDates(wrapListWithAutoPopulatingList(createDateList(distribution.getDates()), AutoPopulatedDateWrapper.class));
        if (distribution.getLicenses().isEmpty()) {
            ...
            distribution.setLicenses(wrapListWithAutoPopulatingList(createLicenseList(distribution.getLicenses()), AutoPopulatedLicenseWrapper.class));
        ...
        if (distribution.getConformsTo().isEmpty()) {
            ...
            distribution.setConformsTo(wrapListWithAutoPopulatingList(createDataStandardList(distribution.getConformsTo()), AutoPopulatedDataStandardWrapper.class));
        if (distribution.getQualifiers().isEmpty()) {
            ...
            distribution.setQualifiers(wrapListWithAutoPopulatingList(createAnnotationList(distribution.getQualifiers()), Annotation.class));
    ...
    public List<String> createFormatList(List<String> formatList) {
    ...
    public List<Identifier> createIdentifierList(List<Identifier> identifierList) {
    ...
    public List<Annotation> createAnnotationList(List<Annotation> annotationList) {
    ...
    public List<Type> createTypeList(List<Type> typeList) {
    ...
    public edu.pitt.isg.mdc.dats2_2.Type createType(Type type) {
        if (type == null) {
    ...
    public List<DataStandard> createDataStandardList(List<DataStandard> dataStandardList) {
    ...
    public DataStandard createDataStandard(DataStandard dataStandard) {
        ...
        if (dataStandard.getAlternateIdentifiers().isEmpty()) {
            ...
            dataStandard.setAlternateIdentifiers(wrapListWithAutoPopulatingList(createIdentifierList(dataStandard.getAlternateIdentifiers()), Identifier.class));
        ...
        if (dataStandard.getLicenses().isEmpty()) {
            ...
            dataStandard.setLicenses(wrapListWithAutoPopulatingList(createLicenseList(dataStandard.getLicenses()), AutoPopulatedLicenseWrapper.class));
        if (dataStandard.getExtraProperties().isEmpty()) {
            ...
            dataStandard.setExtraProperties(wrapListWithAutoPopulatingList(createCategoryValuePairList(dataStandard.getExtraProperties()), CategoryValuePair.class));

        return dataStandard;
    }

    public DataRepository createDataRepository(DataRepository dataRepository) {
        ...
        if (dataRepository.getAlternateIdentifiers().isEmpty()) {
            ...
            dataRepository.setAlternateIdentifiers(wrapListWithAutoPopulatingList(createIdentifierList(dataRepository.getAlternateIdentifiers()), Identifier.class));
        if (dataRepository.getScopes().isEmpty()) {
            ...
            dataRepository.setScopes(wrapListWithAutoPopulatingList(createAnnotationList(dataRepository.getScopes()), Annotation.class));
        if (dataRepository.getTypes().isEmpty()) {
            ...
            dataRepository.setTypes(wrapListWithAutoPopulatingList(createAnnotationList(dataRepository.getTypes()), Annotation.class));
        if (dataRepository.getLicenses().isEmpty()) {
            ...
            dataRepository.setLicenses(wrapListWithAutoPopulatingList(createLicenseList(dataRepository.getLicenses()), AutoPopulatedLicenseWrapper.class));
        if (dataRepository.getPublishers().isEmpty()) {
            ...
            dataRepository.setPublishers(wrapListWithAutoPopulatingList(createPersonComprisedEntityList(dataRepository.getPublishers()), AutoPopulatedPersonComprisedEntityWrapper.class));
        if (dataRepository.getAccess().isEmpty()) {
            ...
            dataRepository.setAccess(wrapListWithAutoPopulatingList(createAccessList(dataRepository.getAccess()), AutoPopulatedAccessWrapper.class));

        return dataRepository;
    }

    public List<IsAbout> createIsAboutList(List<IsAbout> isAboutList) {
    ...
    public IsAboutItems createIsAboutItems(IsAboutItems isAboutItems) {
        ...
        if (isAboutItems.getAlternateIdentifiers().isEmpty()) {
            ...
            isAboutItems.setAlternateIdentifiers(wrapListWithAutoPopulatingList(createIdentifierList(isAboutItems.getAlternateIdentifiers()), Identifier.class));

        return isAboutItems;
    }

    public IsAbout createIsAbout(IsAbout isAbout) {
        if (isAbout == null) {
    ...
    public BiologicalEntity createBiologicalEntity(BiologicalEntity biologicalEntity) {
        ...
        if (biologicalEntity.getAlternateIdentifiers().isEmpty()) {
            ...
            biologicalEntity.setAlternateIdentifiers(wrapListWithAutoPopulatingList(createIdentifierList(biologicalEntity.getAlternateIdentifiers()), Identifier.class));
    ...
    public List<License> createLicenseList(List<License> licenseList) {
    ...
    public License createLicense(License license) {
        ...
        if (license.getCreators().isEmpty()) {
            ...
            license.setCreators(wrapListWithAutoPopulatingList(createPersonComprisedEntityList(license.getCreators()), AutoPopulatedPersonComprisedEntityWrapper.class));

        return license;
    }

    public List<Publication> createPublicationList(List<Publication> publicationList) {
    ...
    public Publication createPublication(Publication publication) {
        ...
        if (publication.getAlternateIdentifiers().isEmpty()) {
            ...
            publication.setAlternateIdentifiers(wrapListWithAutoPopulatingList(createIdentifierList(publication.getAlternateIdentifiers()), Identifier.class));
        ...
        if (publication.getDates().isEmpty()) {
            ...
            publication.setDates(wrapListWithAutoPopulatingList(createDateList(publication.getDates()), AutoPopulatedDateWrapper.class));
        if (publication.getAuthors().isEmpty()) {
            ...
            publication.setAuthors(wrapListWithAutoPopulatingList(createPersonComprisedEntityList(publication.getAuthors()), AutoPopulatedPersonComprisedEntityWrapper.class));
        if (publication.getAcknowledges().isEmpty()) {
            ...
            publication.setAcknowledges(wrapListWithAutoPopulatingList(createGrantList(publication.getAcknowledges()), AutoPopulatedGrantWrapper.class));

        return publication;
    }

    public List<Grant> createGrantList(List<Grant> grantList) {
    ...
    public Grant createGrant(Grant grant) {
        ...
        if (grant.getAlternateIdentifiers().isEmpty()) {
            ...
            grant.setAlternateIdentifiers(wrapListWithAutoPopulatingList(createIdentifierList(grant.getAlternateIdentifiers()), Identifier.class));
        if (grant.getFunders().isEmpty()) {
            ...
            grant.setFunders(wrapListWithAutoPopulatingList(createPersonComprisedEntityList(grant.getFunders()), AutoPopulatedPersonComprisedEntityWrapper.class));
        if (grant.getAwardees().isEmpty()) {
            ...
            grant.setAwardees(wrapListWithAutoPopulatingList(createPersonComprisedEntityList(grant.getAwardees()), AutoPopulatedPersonComprisedEntityWrapper.class));


        return grant;
    }

    public List<Access> createAccessList(List<Access> accessList) {
    ...
    public Access createAccess(Access access) {
        ...
        if (access.getAlternateIdentifiers().isEmpty()) {
            ...
            access.setAlternateIdentifiers(wrapListWithAutoPopulatingList(createIdentifierList(access.getAlternateIdentifiers()), Identifier.class));
        if (access.getTypes().isEmpty()) {
            access.setTypes(wrapListWithAutoPopulatingList(createAnnotationList(null), Annotation.class));
        } else
            access.setTypes(wrapListWithAutoPopulatingList(createAnnotationList(access.getTypes()), Annotation.class));
        if (access.getAuthorizations().isEmpty()) {
            ...
            access.setAuthorizations(wrapListWithAutoPopulatingList(createAnnotationList(access.getAuthorizations()), Annotation.class));
        if (access.getAuthentications().isEmpty()) {
            ...
            access.setAuthentications(wrapListWithAutoPopulatingList(createAnnotationList(access.getAuthentications()), Annotation.class));

        return access;
    }

    public PersonOrganization createPersonOrganization(PersonOrganization personOrganization) {
        ...
        if (personOrganization.getAlternateIdentifiers() == null || personOrganization.getAlternateIdentifiers().isEmpty()) {
            ...
            personOrganization.setAlternateIdentifiers(wrapListWithAutoPopulatingList(createIdentifierList(personOrganization.getAlternateIdentifiers()), Identifier.class));
        ...
        if (personOrganization.getRoles().isEmpty()) {
            ...
            personOrganization.setRoles(wrapListWithAutoPopulatingList(createAnnotationList(personOrganization.getRoles()), Annotation.class));
    ...
    public List<PersonComprisedEntity> createPersonComprisedEntityList(List<PersonComprisedEntity> personComprisedEntityList) {
        if (personComprisedEntityList == null || personComprisedEntityList.isEmpty()) {
            ...
            personComprisedEntityList = new ArrayList<PersonComprisedEntity>();
        }
        ...
        public PersonComprisedEntity createPersonComprisedEntity(PersonComprisedEntity personComprisedEntity) {
...
//                personComprisedEntity = createPersonOrganization((PersonOrganization) personComprisedEntity);
    ...
    public Person createPerson(Person person) {
        ...
        if (person.getAlternateIdentifiers().isEmpty()) {
            ...
            person.setAlternateIdentifiers(wrapListWithAutoPopulatingList(createIdentifierList(person.getAlternateIdentifiers()), Identifier.class));
        if (person.getAffiliations().isEmpty()) {
            ...
            person.setAffiliations(wrapListWithAutoPopulatingList(createOrganizationList(person.getAffiliations()), AutoPopulatedOrganizationWrapper.class));
        if (person.getRoles().isEmpty()) {
            person.setRoles(wrapListWithAutoPopulatingList(createAnnotationList(null), Annotation.class));
        } else
            person.setRoles(wrapListWithAutoPopulatingList(createAnnotationList(person.getRoles()), Annotation.class));

        return person;
    }

    public List<Organization> createOrganizationList(List<Organization> organizationList) {
        ...
        for (int i = 0; i < maxIterations(organizationList.size()); i++) {
            if (i > (organizationList.size() - 1)) {
                ...
                if (organizationList.get(i).getAlternateIdentifiers().isEmpty()) {
                    ...
                    organizationList.get(i).setAlternateIdentifiers(wrapListWithAutoPopulatingList(createIdentifierList(organizationList.get(i).getAlternateIdentifiers()), Identifier.class));
    ...
    public Organization createOrganization(Organization organization) {
        ...
        if (organization.getAlternateIdentifiers().isEmpty()) {
            ...
            organization.setAlternateIdentifiers(wrapListWithAutoPopulatingList(createIdentifierList(organization.getAlternateIdentifiers()), Identifier.class));
    ...
    public List<Place> createPlaceList(List<Place> placeList) {
    ...
    public Place createPlace(Place place) {
        ...
        if (place.getAlternateIdentifiers().isEmpty()) {
            ...
            place.setAlternateIdentifiers(wrapListWithAutoPopulatingList(createIdentifierList(place.getAlternateIdentifiers()), Identifier.class));

        return place;
    }

    public List<edu.pitt.isg.mdc.dats2_2.Date> createDateList(List<edu.pitt.isg.mdc.dats2_2.Date> dateList) {
    ...
    public edu.pitt.isg.mdc.dats2_2.Date createDate() {
    ...
    public List<CategoryValuePair> createCategoryValuePairList(List<CategoryValuePair> categoryValuePairList) {
        ...
        for (int i = 0; i < maxIterations(categoryValuePairList.size()); i++) {
            if (i > (categoryValuePairList.size() - 1)) {
                ...
                if (categoryValuePairList.get(i).getValues() == null) {
                    ...
                    categoryValuePairList.get(i).setValues(wrapListWithAutoPopulatingList(createAnnotationList(categoryValuePairList.get(i).getValues()), Annotation.class));
            }
        } //end for loop
    ...
    public CategoryValuePair createCategoryValuePair(CategoryValuePair categoryValuePair) {
